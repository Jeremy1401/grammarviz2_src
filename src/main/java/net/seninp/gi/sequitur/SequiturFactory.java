...
public final class SequiturFactory {
    ...
    public static SAXRule runSequitur(String inputString) throws Exception {
        ...
        //LOGGER.info("digesting the string " + inputString);
        ...
        while (st.hasMoreTokens()) {
            ...
            //LOGGER.info(" processing the token " + token);
            ...
            //System.out.println("resRule.last().value = " + resRule.last().value);
...
//        LOGGER.info("Current grammar:\n" + resRule.printRules());
    ...
    public static void updateRuleIntervals(GrammarRules rules, SAXRecords saxFrequencyData,
        ...
        for (GrammarRuleRecord ruleContainer : rules) {
            ...
            //LOGGER.info("ruleContainer: " + ruleContainer.getRuleName() + " " + ruleContainer.getExpandedRuleString());
            ...
            for (Integer currentIndex : ruleContainer.getOccurrences()) {
                ...
                if ((currentIndex + expandedRuleLength) >= saxWordsIndexes.size()) {
                    ...
                    if (slidingWindowOn) {
                        //LOGGER.info("expandedRuleLength: " + expandedRuleLength);
                        //LOGGER.info("saxWordsIndexes.get(currentIndex + expandedRuleLength): " + saxWordsIndexes.get(currentIndex + expandedRuleLength));
                ...
                resultIntervals.add(new RuleInterval(ruleContainer.getRuleNumber(), startPos, endPos));

                lengths[lengthCounter] = endPos - startPos;
                lengthCounter++;
            }
            if (0 == ruleContainer.getRuleNumber()) {
                resultIntervals.add(new RuleInterval(0, 0, originalTimeSeries.length));
                lengths = new int[1];
                lengths[0] = originalTimeSeries.length;
            }
            ruleContainer.setRuleIntervals(resultIntervals);
//            LOGGER.info("ruleContainer.rule: " + ruleContainer.getRuleName() + "   " + ruleContainer.getExpandedRuleString());
//            LOGGER.info("sax: "+ ruleContainer);
//            LOGGER.info("ruleContainer.intervals: "  + ruleContainer.getRuleIntervals().toString());
//            LOGGER.info("-----------------\n");
