...
public class GrammarvizOptionsPane extends JPanel {
    ...
    private static final JCheckBox useSpark = new JCheckBox("use spark", true);
    ...
    private Component buildOptionsPanel() {
        ...
        MigLayout optionsPaneLayout = new MigLayout("insets 0 0 0 0", "[]10[]", "[]");
        optionsPanel.setLayout(optionsPaneLayout);

        optionsPanel.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(BevelBorder.LOWERED), "Options", TitledBorder.LEFT,
