...
public class AbstractionTest
{
      ...
      public static void main(String[] args)
      {
         ...
         else
         {
            ...
            final WarpPath coarsePath = com.dtw.DTW.getWarpPathBetween(shrunkI, shrunkJ, distFn);
            ...
            final TimeWarpInfo info = com.dtw.DTW.getWarpInfoBetween(tsI, tsJ, w, distFn);
