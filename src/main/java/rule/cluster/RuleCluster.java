...
public class RuleCluster {
    ...
    private ArrayList<Integer> ruleIds = new ArrayList<Integer>();  // the rule ids in this cluster including the center rule Id
    private ArrayList<RuleInterval> ruleIntervals = new ArrayList<RuleInterval>();
