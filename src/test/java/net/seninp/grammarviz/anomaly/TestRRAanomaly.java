...
public class TestRRAanomaly {
    ...
    private static final String TEST_DATA_FNAME = "/Users/Jeremy/Desktop/毕设/参考文献/导师推荐/代码/grammarviz3-optimized/data/TEK17.txt";

    private static final int WIN_SIZE = 160;
    private static final int PAA_SIZE = 20;
